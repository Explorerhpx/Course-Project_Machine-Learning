...
% Output:
%
%   p = probabilities of clusters 每一个类的概率
%   mu(:,c) = mean of the cth cluster c类的均值
%   vary(:,c) = variances for the cth cluster c的方差
